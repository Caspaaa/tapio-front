...
export function EditPostForm({ post, posts, setPosts, onUpdated, onEdit }: EditPostFormProps): JSX.Element {
	...
	return (
		<form onSubmit={updatePost} onClick={(event) => event.stopPropagation()} className="flex flex-col h-full">
			...
			<div className="w-full flex justify-end items-end mt-4">
				<div>
					...
					<button
						...
						className="bg-tapio text-white p-2 rounded-full duration-200"
					>
